 ...
 *
 * GENERATED CODE - see src/xrt/state_trackers/oxr/extension_support/!
 *
 * To add support for a new extension, edit oxr_extension_support.py and
 * rebuild.
 *
...
// Per-extension defines (OXR_HAVE_* and OXR_EXTENSION_SUPPORT_*() macros)
 ...
 */
#if defined(XR_KHR_composition_layer_depth) && defined(ALWAYS_DISABLED)
 ...
 */
#if defined(XR_KHR_generic_controller) && defined(XRT_FEATURE_OPENXR_INTERACTION_KHR_GENERIC)
#define OXR_HAVE_KHR_generic_controller
#define OXR_EXTENSION_SUPPORT_KHR_generic_controller(_) \
    _(KHR_generic_controller, KHR_GENERIC_CONTROLLER)
#else
#define OXR_EXTENSION_SUPPORT_KHR_generic_controller(_)
#endif
...
#define OXR_EXTENSION_SUPPORT_ANDROID_face_tracking(_) \
    _(ANDROID_face_tracking, ANDROID_FACE_TRACKING)
#else
#define OXR_EXTENSION_SUPPORT_ANDROID_face_tracking(_)
#endif
 ...
 * XR_BD_body_tracking
 */
#if defined(XR_BD_body_tracking) && defined(XRT_FEATURE_OPENXR_BODY_TRACKING_BD)
#define OXR_HAVE_BD_body_tracking
#define OXR_EXTENSION_SUPPORT_BD_body_tracking(_) \
    _(BD_body_tracking, BD_BODY_TRACKING)
#else
#define OXR_EXTENSION_SUPPORT_BD_body_tracking(_)
#endif
 ...
 */
#if defined(XR_LOGITECH_mx_ink_stylus_interaction) && defined(XRT_FEATURE_OPENXR_INTERACTION_LOGITECH_MX_INK)
#define OXR_HAVE_LOGITECH_mx_ink_stylus_interaction
#define OXR_EXTENSION_SUPPORT_LOGITECH_mx_ink_stylus_interaction(_) \
    _(LOGITECH_mx_ink_stylus_interaction, LOGITECH_MX_INK_STYLUS_INTERACTION)
#else
#define OXR_EXTENSION_SUPPORT_LOGITECH_mx_ink_stylus_interaction(_)
#endif
...
#define OXR_EXTENSION_SUPPORT_MNDX_psvr2_interaction(_) \
    _(MNDX_psvr2_interaction, MNDX_PSVR2_INTERACTION)
#else
#define OXR_EXTENSION_SUPPORT_MNDX_psvr2_interaction(_)
#endif
...
#define OXR_EXTENSION_SUPPORT_GENERATE(_) \
    ...
    OXR_EXTENSION_SUPPORT_KHR_generic_controller(_) \
    ...
    OXR_EXTENSION_SUPPORT_BD_body_tracking(_) \
    ...
    OXR_EXTENSION_SUPPORT_LOGITECH_mx_ink_stylus_interaction(_) \
